        ...
        SheetView(isPresented: $isPresented, bgOpacity: 0.3) {
            VStack(spacing: 16) {
                ...
                if textEditor.textBoxes.isEmpty {
                            ...
                            ZStack(alignment: .topLeading) {
                                ...
                                ForEach(Array(textEditor.textBoxes.enumerated()), id: \.offset) { index, textBox in
                                    ...
                                    Rectangle()
                                        ...
                                        .position(x: (UIScreen.main.bounds.width - 40) / 2 + 20, y: startY)
                                        .zIndex(500)
                                    ...
                                    Rectangle()
                                        .fill(Color.white.opacity(0.6))
                                        .frame(width: UIScreen.main.bounds.width - 40, height: 1)
                                        .position(x: (UIScreen.main.bounds.width - 40) / 2 + 20, y: endY)
                                        .zIndex(500)
                                    ...
                                    .frame(maxWidth: UIScreen.main.bounds.width - 80) // Give space for edit button
                                    .background(Color.clear)
                                    .position(x: (UIScreen.main.bounds.width - 80) / 2 + 40, y: startY + rowHeight / 2)
                                    .id(index)
                                }
                                ...
                                .position(x: (UIScreen.main.bounds.width - 40) / 2 + 20, y: CGFloat(videoPlayer.currentTime) * timelineScale)
                                .zIndex(1000)
                            }
                    ...
                    .frame(maxWidth: .infinity, maxHeight: UIScreen.main.bounds.height / 2 - 20)
                }
            }
        }
    }
